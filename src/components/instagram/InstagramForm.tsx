    ...
    <>
      ...
      >
        ...
        <input
          ...
          className="w-full px-2 py-3 border rounded border-slate-100 placeholder-gray-400/80 drop-shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-none dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
        />
